            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name mt-1 ">@if(!empty(Auth::user()->full_name)) {{Auth::user()->full_name}}(Head Office) @endif</span></div><span><img class="round" src="{{(!empty(!Auth::user()->photo))? asset('app-assets/images/profile/user_icon.jpg') : asset('app-assets/images/profile/user_icon.jpg')}}" alt="avatar" height="40" width="40"></span>
                        </a>
